    ...
    <section className="sidebar">
      ...
      <div className="user-panel">
        ...
        <div className="pull-left info">
          ...
          <a href="fakeLink"><i className="fa fa-circle text-success" /> Online</a>
        </div>
      </div>
      {/* search form */}
      ...
      <ul className="sidebar-menu" data-widget="tree">
        ...
        <li className="treeview">
          ...
          <ul className="treeview-menu">
            <li><a href="fakeLink"><i className="fa fa-circle-o" /> Level One</a></li>
            <li className="treeview">
              <a href="fakeLink"><i className="fa fa-circle-o" /> Level One
                <span className="pull-right-container">
                  <i className="fa fa-angle-left pull-right" />
                </span>
              </a>
              <ul className="treeview-menu">
                <li><a href="fakeLink"><i className="fa fa-circle-o" /> Level Two</a></li>
                <li className="treeview">
                  <a href="fakeLink"><i className="fa fa-circle-o" /> Level Two
                    <span className="pull-right-container">
                      <i className="fa fa-angle-left pull-right" />
                    </span>
                  </a>
                  <ul className="treeview-menu">
                    <li><a href="fakeLink"><i className="fa fa-circle-o" /> Level Three</a></li>
                    <li><a href="fakeLink"><i className="fa fa-circle-o" /> Level Three</a></li>
                  </ul>
                </li>
              </ul>
        ...
        <li><a href="fakeLink"><i className="fa fa-circle-o text-red" /> <span>Important</span></a></li>
        <li><a href="fakeLink"><i className="fa fa-circle-o text-yellow" /> <span>Warning</span></a></li>
        <li><a href="fakeLink"><i className="fa fa-circle-o text-aqua" /> <span>Information</span></a></li>
      </ul>
    </section>
    {/* /.sidebar */}
  </aside>
