...
export default function Header() {
  ...
  <header className="main-header">
    ...
    <a href="index2.html" className="logo">
      ...
      <span className="logo-lg"><b>Lojas Grand Cell</b></span>
    </a>
    {/* Header Navbar: style can be found in header.less */}
    <nav className="navbar navbar-static-top">
      {/* Sidebar toggle button*/}
      <a href="fakeLink" className="sidebar-toggle" data-toggle="push-menu" role="button">
        ...
        <ul className="nav navbar-nav">
          ...
          <li className="dropdown messages-menu">
            ...
            <ul className="dropdown-menu">
              ...
              <li className="footer"><a href="fakeLink">See All Messages</a></li>
            </ul>
          </li>
          ...
          <li className="dropdown notifications-menu">
            ...
            <ul className="dropdown-menu">
              ...
              <li className="footer"><a href="fakeLink">View all</a></li>
            </ul>
          </li>
          ...
          <li className="dropdown tasks-menu">
            ...
            <ul className="dropdown-menu">
              ...
              <li className="footer">
                <a href="fakeLink">View all tasks</a>
              </li>
            </ul>
          </li>
          ...
          <li className="dropdown user user-menu">
            ...
            <ul className="dropdown-menu">
              ...
              <li className="user-body">
                <div className="row">
                  <div className="col-xs-4 text-center">
                    <a href="fakeLink">Followers</a>
                  </div>
                  <div className="col-xs-4 text-center">
                    <a href="fakeLink">Sales</a>
                  </div>
                  <div className="col-xs-4 text-center">
                    <a href="fakeLink">Friends</a>
                  </div>
                </div>
                {/* /.row */}
              </li>
              ...
              <li className="user-footer">
                <div className="pull-left">
                  <a href="fakeLink" className="btn btn-default btn-flat">Profile</a>
                </div>
                <div className="pull-right">
                  <a href="fakeLink" className="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
          ...
          <li>
            <a href="fakeLink" data-toggle="control-sidebar"><i className="fa fa-gears" /></a>
          </li>
        </ul>
      </div>
    </nav>
